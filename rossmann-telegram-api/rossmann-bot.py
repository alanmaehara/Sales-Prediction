...
def load_dataset(store_Id):
    ...
    df10 = pd.read_csv('/home/alan/Sales-Prediction/data/test_with_customers.csv')
    df_store_raw = pd.read_csv('/home/alan/Sales-Prediction/data/store.csv')
...
if __name__ == '__main__':
    app.run( host = '0.0.0.0', port = 5000) # run app at host 0.0.0.0 on port 5000.
